<head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="<?= base_url() ?>layout/favicon.ico" type="image/x-icon">
...
<body class="login-page">
            ...
            <div class="body">
                <?php echo form_open(base_url('admin/auth/login'), 'class="login-form" '); ?>
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" name="nrp" placeholder="Username" required autofocus>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <button name="submit" id="submit" value="submit" class="btn btn-block bg-pink waves-effect" type="submit">SIGN IN</button>
                        </div>
                    </div>
    ...
    <script src="<?= base_url() ?>layout/plugins/jquery-validation/jquery.validate.js"></script>

    <!-- Custom Js -->
    <script src="<?= base_url() ?>layout/js/admin.js"></script>
    <script src="<?= base_url() ?>layout/js/pages/examples/sign-in.js"></script>
</body>